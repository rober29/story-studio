...
FORMAT_HINTS = {
    ...
    "D": (
        ...
        "NADA de texto, letras ni números dentro de las imágenes: el texto lo pone "
        "la capa de subtítulos. Con UNA excepción, y solo si el dato ES la "
        "historia (una fecha en una proclama, una cifra en un billete): añade "
        "'[CON TEXTO]' al final de ese prompt y describe LITERALMENTE lo que debe "
        "poner. Comprobado, el generador lo respeta al pie de la letra.\n"
        "Pero solo con texto NEUTRO DE IDIOMA —números, fechas, nombres propios, "
        "símbolos—. Nunca palabras que cambien entre español e inglés: las dos "
        "versiones del reel comparten las MISMAS imágenes, y eso es lo que hace "
        "que la traducción cueste cero. Una palabra traducible dentro de la imagen "
        "obliga a generarlas dos veces y duplica el coste del tema.\n"
